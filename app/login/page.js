  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950">
      ...
      <div className="max-w-sm w-full relative z-10">
        <h1 className="text-3xl font-semibold text-white mb-2 text-center">Welcome back</h1>
        <p className="text-slate-400 text-sm mb-8 text-center">Log in to your dashboard</p>
        ...
        <p className="text-slate-500 text-sm text-center mt-6">
          ...
          <a href="/signup" className="text-orange-400 hover:text-orange-300">Sign up</a>
        </p>
      </div>
    </main>
  );

    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16 bg-gradient-to-b from-orange-50 via-white to-white">
      <div className="max-w-sm w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-3xl shadow-lg shadow-orange-100/50 p-8">
          <h1 className="text-2xl font-semibold text-gray-900 mb-1 text-center">Create your account</h1>
          <p className="text-gray-500 text-sm mb-8 text-center">Start tracking your app&apos;s reviews — free for 30 days</p>
        ...
        <p className="text-gray-500 text-sm text-center mt-6">
          ...
          <a href="/login" className="text-orange-600 hover:text-orange-700 font-medium">Log in</a>
        </p>
      </div>
    </main>
  );
